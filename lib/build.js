...
module.exports = {
	...
	buildStaticAssets: function(rootDir, configure, newVersion, opts, callback) {
		...
		if (configure.subtype == "static") {
			var jsStaticDir = path.normalize(path.resolve(rootDir, "static/**"));

			var distStaticDir = path.normalize(path.join(rootDir, `/dist/`));
...
function buildLambdaDirectory(rootDir, opts, callback) {
	...
	b.transform(babelify, {
		...
		sourceMaps: false,
		sourceType: "unambiguous",
		plugins: [	"@babel/plugin-proposal-export-namespace-from", "@babel/plugin-transform-modules-commonjs", "@babel/plugin-proposal-function-bind"]
	});
